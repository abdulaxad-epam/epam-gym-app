...
public interface AuthenticationService {
    TraineeResponseDTO register(RegisterTraineeRequestDTO userRequestDTO, HttpServletResponse response);

    TrainerResponseDTO register(RegisterTrainerRequestDTO userRequestDTO, HttpServletResponse response);
