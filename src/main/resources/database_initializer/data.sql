...
-- Insert Users
INSERT INTO users (user_id, firstname, lastname, username, password, is_active) VALUES ('a1b2c3d4-e5f6-4a1b-8c1d-1a2b3c4d5e6f', 'John', 'Jose', 'john.jose', 'pass123456', true);
INSERT INTO users (user_id, firstname, lastname, username, password, is_active) VALUES ('b2c3d4e5-f6a1-4b2c-9d1e-2a3b4c5d6e7f', 'Jane', 'Smith', 'jane.smith', 'pass456rfh', true);
INSERT INTO users (user_id, firstname, lastname, username, password, is_active) VALUES ('c3d4e5f6-a1b2-4c3d-0e1f-3a4b5c6d7e8f', 'Michael', 'Johnson', 'michael.johnson', 'pass789hds', true);
INSERT INTO users (user_id, firstname, lastname, username, password, is_active) VALUES ('d4e5f6a1-b2c3-4d4e-1f1a-4a5b6c7d8e9f', 'Emma', 'Williams', 'emma.williams', 'pass101ye2', true);

INSERT INTO users (user_id, firstname, lastname, username, password, is_active) VALUES ('e5f6a1b2-c3d4-4e5f-2a1b-5a6b7c8d9e0f', 'Robert', 'Brown', 'robert.brown', 'tra234rpas', true);
INSERT INTO users (user_id, firstname, lastname, username, password, is_active) VALUES ('f6a1b2c3-d4e5-4f6a-3b1c-6a7b8c9d0e1f', 'Sarah', 'Davis', 'sarah.davis', 'traijtbpas', true);
INSERT INTO users (user_id, firstname, lastname, username, password, is_active) VALUES ('1a2b3c4d-5e6f-4a1b-4c1d-7a8b9c0d1e2f', 'David', 'Miller', 'david.miller', 'trainer3gs', true);
INSERT INTO users (user_id, firstname, lastname, username, password, is_active) VALUES ('2b3c4d5e-6f1a-4b2c-5d1e-8a9b0c1d2e3f', 'Lisa', 'Wilson', 'lisa.wilson', 'train6bsas', true);

INSERT INTO users (user_id, firstname, lastname, username, password, is_active) VALUES ('3c4d5e6f-7a8b-4c3d-9e0f-9a0b1c2d3e4f', 'James', 'Taylor', 'james.taylor', 'trainhm2as', true);
INSERT INTO users (user_id, firstname, lastname, username, password, is_active) VALUES ('4d5e6f7a-8b9c-4d5e-0f1a-0b1c2d3e4f5a', 'Emily', 'Anderson', 'emily.anderson', 'trai89jpas', true);
