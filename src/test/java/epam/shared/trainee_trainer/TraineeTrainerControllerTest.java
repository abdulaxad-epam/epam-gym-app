...
import epam.shared.trainee_trainer.controller.TraineeTrainerController;
...
class TraineeTrainerControllerTest {
    ...
    void testGetNotAssignedTrainers_Success() {
        ...
        ResponseEntity<List<TrainerResponseDTO>> response = traineeTrainerController.getNotAssignedTrainers(username);
    ...
    void testUpdateTraineeTrainerList_Success() {
        ...
        ResponseEntity<List<TrainerResponseDTO>> response = traineeTrainerController.updateTraineeTrainerList(username, trainerUsernames);
