...
public class TrainerControllerTest {
    ...
    void testGetTrainer_Success() {
        ...
        // Act
        ResponseEntity<TrainerResponseDTO> response = trainerController.getTrainer("testTrainer", "password");
    ...
    void testUpdateTrainer_Success() {
        ...
        // Act
        ResponseEntity<TrainerResponseDTO> response = trainerController.updateTrainer("testTrainer", trainerRequestDTO, "password");
    ...
    void testGetTrainings_Success() {
        ...
        ResponseEntity<List<TrainingResponseDTO>> response = trainerController.getTrainings(
                "testTrainer", "2024-01-01", "2024-12-31", "testTrainee", "password");
    ...
    void testTrainerStatus_Success() {
        ...
        // Act
        ResponseEntity<Void> response = trainerController.trainerStatus("testTrainer", true, "password");
